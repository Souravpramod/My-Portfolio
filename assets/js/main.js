...
const scriptURL = "https://script.google.com/macros/s/AKfycby4ILgh1TFbuA2AGxoRwyWhJXd8spWYmTQF9f_z7qeffMF41FYKK3_JSNFMEoRia-v5/exec";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initTestimonials() {
    document.querySelectorAll(".init-swiper").forEach(function(swiperElement) {
      ...
      // force re-init even if template failed before
      new Swiper(swiperElement, config);
    });
  }

  // Wait until Swiper library is ready
  if (typeof Swiper !== "undefined") {
    initTestimonials();
  } else {
    // retry until Swiper loads
